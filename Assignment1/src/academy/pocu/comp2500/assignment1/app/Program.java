...
//        assert post.getAuthor().equals(user1);
//
//        assert post.updateTitle(user1, "About Math");
//        assert post.updateBody(user1, "Math is ...");
//
...
//
//        assert blog.addPost(user1, "About CS", "CS is ...");
//        assert blog.addPost(post2);
//
...
//        assert !blog.addPost(post1);
//
//        blog.setPostsFilteredByAuthor(user2);
//        ArrayList<Post> posts = blog.getPosts();
//
//        assert posts.size() == 1;
//        assert posts.get(0).getTitle().equals("About Unreal");
//        assert posts.get(0).getAuthor().equals(user2);
//    }
//
...
//        assert blog.addPost(post2);
//        assert blog.addPost(post3);
//        assert blog.addPost(post4);
//        assert blog.addPost(post5);
//        assert blog.addPost(post6);
//
//        // CREATE
...
//
//        assert blog.addPost(post1);
//        assert !blog.addPost(new Post(user2, "About Null", "Null is ..."));
//
//        ArrayList<Comment> comments = post1.getComments();
//
//        assert comments.size() == 1;
//        assert comments.get(0).getAuthor().equals(user2);
//    }
//
...
//
//
//        blog.addPost(new Post(user1, "About Time", "Time is ..."));
//        Post post = blog.getPosts().get(0);
//        post.addComment(user2, "Awsome!!");
//
//        Comment comment = post.getComments().get(0);
//
//        assert comment.getAuthor().equals(user2);
//
//        comment.addSubcomment(user1, "Thanks bro!");
//
//        Comment subcomment = comment.getSubcomments().get(0);
//
//        assert subcomment.getComment().equals("Thanks bro!");
//    }
//
...
//
//        post.addComment(user1, "Awesome!!");
//        post.addComment(user2, "So so");
//
//        assert comments.size() == 2;
//
//        assert (comments.get(0).addDownvote(user1));
//        assert (comments.get(1).addUpvote(user2));
//        assert (!comments.get(0).addDownvote(user1));
//
...
//
//        Comment comment = getPost1.getComments().get(0);
//
//        comment.addSubcomment(user4, "Umm.. I don't think so!!");
//        comment.addSubcomment(user3, "Yeah, I think so!!");
//
//        ArrayList<Comment> subcomments = comment.getSubcomments();
//
